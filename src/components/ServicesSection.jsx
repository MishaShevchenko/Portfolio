...
const ServicesSection = ({ theme }) => {
  return (
    <section
      id="services"
      className={`relative py-20 transition-colors duration-300 backdrop-blur-sm ${
    ...
    >
      ...
      <div className="relative align-element z-10">
        ...
        <p className="text-center text-slate-500 dark:text-slate-400 mt-3 mb-12 max-w-xl mx-auto">
          From interactive UIs to scalable APIs — here&apos;s where I can add
          value to your team or project.
        </p>
          ...
          {services.map((service, index) => {
            ...
            return (
              <motion.div
                ...
                className={`rounded-2xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 flex flex-col group backdrop-blur-sm ${
              ...
              >
                ...
                <div className="flex flex-col flex-1 p-6 gap-4">
                  ...
                  <div
                    className={`h-px ${
                      theme === "dark" ? "bg-gray-700/60" : "bg-gray-100/60"
                    }`}
                  />
